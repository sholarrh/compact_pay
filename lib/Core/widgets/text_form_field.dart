...
class UssdInputField extends StatefulWidget {
  final Widget? prefixIcon;
  final String hintText;
  final TextEditingController inputController;
  final Function? validator;
  ...
  @override
  State<UssdInputField> createState() => _UssdInputFieldState();
}

class _UssdInputFieldState extends State<UssdInputField> {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: TextFormField(
        ...
        onSaved: (value) => widget.onSaved!(value),
        style: const TextStyle(
            fontSize: 20, color: black2121, fontWeight: FontWeight.w500),
        showCursor: true,
        obscureText: _obscureText,
        decoration: InputDecoration(
          border: InputBorder.none,
